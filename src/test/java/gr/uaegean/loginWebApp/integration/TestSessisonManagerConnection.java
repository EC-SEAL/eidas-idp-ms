...
//        String hostUrl = "http://vm.project-seal.eu:9090"; //"https://esmo-gateway.eu";
//
...
//
//        System.out.println("new api starting session");
//        postParams.add(new NameValuePair("sessionId", sessionId));
//        resp = this.mapper.readValue(netServ.sendPostForm(hostUrl, "/sm/new/startSession", postParams, 1), SessionMngrResponse.class);
//        System.out.println(resp.getCode() + " NEW API");
...
//        resp = this.mapper.readValue(netServ.sendPostBody(hostUrl, uri, updateDR, "application/json", 1), SessionMngrResponse.class);
//        System.out.println(resp.getCode().toString() + "2!!!!!!!!!");
//
//        updateDR = new UpdateDataRequest();
//        updateDR.setSessionId(sessionId);
...
//        resp = this.mapper.readValue(netServ.sendPostBody(hostUrl, uri, updateDR, "application/json", 1), SessionMngrResponse.class);
//        System.out.println(resp.getCode().toString() + "3!!!!!!!!!");
//
//        NewUpdateDataRequest update = new NewUpdateDataRequest(sessionId, "dataSet", "\"{\"the\":\"object\"}\"", "id");
//        resp = mapper.readValue(netServ.sendPostBody(hostUrl, "/sm/new/add", update, "application/json", 1), SessionMngrResponse.class);
//        System.out.println(resp.getCode().toString() + "4!!!!!!!!!");
//
//        uri = "/sm/new/search";
//        postParams.clear();
//        postParams.add(new NameValuePair("sessionId", sessionId));
